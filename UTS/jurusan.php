        ...
        <div class="container p-5 my-5 border border-dark">
            ...
            <form action="prosesJurusan.php" method="POST">
                ...
                <div class="mb-3 mt-3">
                    ...
                    <input type="number" class="form-control" placeholder="kode jurusan" name="kode jurusan" min="0" max="9" step="0.01" required>
                </div>
                <div class="mb-3 mt-3">
        ...
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?= $data['jurusan'] ?></td>
                    <td>
                        <a href="editJurusan.php?nim=<?= $data['nim'] ?>" class="btn btn-warning btn-sm">Edit</a>
                        <a href="deleteJurusan.php?nim=<?= $data['nim'] ?>" class="btn btn-danger btn-sm">Delete</a>
                    </td>
                </tr>
                <?php } ?>
            </tbody>
